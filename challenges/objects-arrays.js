...
const tyrannosaurus = {
  ...
  roar: function (){
    return "RAEERSRRARARWERSARARARRRR!";
  }
};
...
console.log(`The ${tyrannosaurus.name} yells ${tyrannosaurus.roar()}`);
...
*/
const populationTotal = zooAnimals.reduce((total, animal) => total + animal.population);
